...
Two useful framings before we begin. First, treat the port scan as incomplete by design — the interesting service will not be in it, and understanding _why_ is the core lesson of this box. Second, everything you paste from your terminal becomes the evidence for the walkthrough; I'll build the document from your real output, not from the attached writeup's examples, and I'll scrub the IP to `TARGET_IP` throughout.
<div align="center">
<br>
<br>
※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※
