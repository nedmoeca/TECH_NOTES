...
Accept the self-signed certificate warning. The certificate observed in  is issued for `cohort.htb` by an untrusted authority, which is expected on this target.
