...
| TryHackMe - Metasploit: Introduction                                                         | Guided room                    | Free         | Framework structure, module types, and console navigation. The natural next step after this room.                                                                                                                                                                                       |
| TryHackMe - Metasploit: Exploitation                                                         | Guided room                    | Free         | Running exploits against varied targets. Reinforces the exploit-versus-payload separation covered in section 2.1.                                                                                                                                                                       |
| TryHackMe - Metasploit: Meterpreter                                                          | Guided room                    | Free         | Meterpreter's command set in depth. Directly extends section 3 of this walkthrough.                                                                                                                                                                                                     |
| TryHackMe - Msfvenom                                                                         | Guided room                    | Free         | Generating standalone payloads for delivery outside a Metasploit exploit. A related but distinct skill; take it after the three rooms above.                                                                                                                                            |
|                                                                                              |                                |              |                                                                                                                                                                                                                                                                                         |
| Resource                                                                                     | Format                         | Cost         | Notes                                                                                                                                                                                                                                                                                   |
| [TryHackMe — Metasploit module](https://tryhackme.com/module/metasploit)                     | Three guided rooms in sequence | Free         | Introduction covers the framework's components; Exploitation covers scanning and running exploits against varied targets; Meterpreter goes deep on in-memory payloads and post-exploitation. The three map almost exactly onto sections 2 and 3 of this walkthrough, so take them next. |
