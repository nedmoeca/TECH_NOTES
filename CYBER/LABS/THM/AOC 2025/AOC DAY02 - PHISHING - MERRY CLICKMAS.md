...
description: Learn how to use the Social-Engineer Toolkit to send phishing emails.
image: https://tryhackme-images.s3.amazonaws.com/room-icons/6645aa8c024f7893371eb7ac-1761822143495
---
## Summary
...
- **SMTP email server address**: We will deliver directly to the TBFC mail server by entering `10.65.145.89`.
...
- **Enter the body of the message, and type END (capitals) when finished:** Create and type any convincing message. Make sure to include the URL `http://10.65.135.240:8000` to check if the target will fall for this trick.
...
set:phishing> SMTP email server address (ex. smtp.youremailserveryouown.com):10.65.145.89
...
Next line of the body: Please confirm the new schedule by visiting http://10.65.135.240:8000
