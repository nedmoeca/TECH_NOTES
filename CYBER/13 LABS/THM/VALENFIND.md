...
Anything that lets a user pick a value which then changes how the server builds a page is worth a close look. To understand the mechanism, we read the **raw HTML source** of the profile page. "View source" shows the exact HTML the server sent, including any JavaScript and hidden clues — which the rendered page hides from view.
<div align="center">
<br>
<br>
※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※
